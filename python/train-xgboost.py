...
USEFEATURES = ['ID',  'ask_1', 'bid_size_1', 'ask_size_1', 'bid_1', 'nb_trade', 'bid_entropy_1', 'ask_entropy_1', 'bid_size_2', 'ask_size_2']
SKIPFEATURES = 4
...
pandas.DataFrame({'ID': np.arange(1, n_samples+1), 'TARGET': y_pred_test}).to_csv('/tmp/pred.csv')
